        ...
        if (d < 0  ||  d > 7)
            switch(colcase)
                ...
                case 0:
                    ...
                    posptr -> sa.pos[f].scr[r] [tup] &= 0x3Fu;
                    break;
                case 1:
                    posptr -> sa.pos[f].scr[r] [tab] &= 0xC0u;
                    posptr -> sa.pos[f].scr[r] [tup] &= 0x1Fu;
                    break;
                case 2:
                    posptr -> sa.pos[f].scr[r] [tab] &= 0xE0u;
                    posptr -> sa.pos[f].scr[r] [tup] &= 0x0Fu;
                    break;
                case 3:
                    posptr -> sa.pos[f].scr[r] [tab] &= 0xF0u;
                    posptr -> sa.pos[f].scr[r] [tup] &= 0x07u;
                    break;
                case 4:
                    posptr -> sa.pos[f].scr[r] [tab] &= 0xF8u;
                    posptr -> sa.pos[f].scr[r] [tup] &= 0x03u;
                    break;
                case 5:
                    posptr -> sa.pos[f].scr[r] [tab] &= 0xFCu;
                    posptr -> sa.pos[f].scr[r] [tup] &= 0x01u;
                    break;
                case 6:
                    posptr -> sa.pos[f].scr[r] [tab] &= 0xFEu;
                    posptr -> sa.pos[f].scr[r] [tup] = 0x00u;
                    break;
                case 7:
                    posptr -> sa.pos[f].scr[r] [tup] = 0x00u;
                    break;
